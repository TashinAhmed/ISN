...
class ShapeImageGenerator:
    ...
    def generate_and_save_images_and_masks(self):
        """Generate and save N images and masks with specified configurations."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Generate random shape images and masks.")
    
    parser.add_argument('--img_height', type=int, default=224, help="Height of the generated images.")
    parser.add_argument('--img_width', type=int, default=224, help="Width of the generated images.")
    parser.add_argument('--min_shape_px', type=int, default=20, help="Minimum size of the shapes.")
    parser.add_argument('--max_shape_px', type=int, default=40, help="Maximum size of the shapes.")
    parser.add_argument('--num_images', type=int, default=100, help="Number of images to generate.")
    parser.add_argument('--image_dir', type=str, default='dataset/images', help="Directory to save generated images.")
    parser.add_argument('--mask_dir', type=str, default='dataset/masks', help="Directory to save generated masks.")
