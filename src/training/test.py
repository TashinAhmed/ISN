...
def test():
    ...
    isn_data = ISNDataModule(train_df=None, valid_df=None, test_df=test_df, batch_size=BATCH_SIZE, img_size=IMG_SIZE, preprocess_fn=preprocess_input, class_rgb_values=class_rgb_values)

    segmodel = SegmentationModel.load_from_checkpoint(checkpoint_path=CHECKPOINT_FILE)
