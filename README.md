...
<span style="color:red;">*A Jupyter [notebook]([url](https://github.com/TashinAhmed/ISN/blob/main/notebooks/ISN_train_eval_run.ipynb)) that followed steps 1-3, 5, 6 run sccessfully on colab free version.*</span>
